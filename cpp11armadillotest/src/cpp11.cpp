...
extern "C" SEXP _cpp11armadillotest_typedef_spmat_exchangeability(SEXP x) {
  BEGIN_CPP11
    return cpp11::as_sexp(typedef_spmat_exchangeability(cpp11::as_cpp<cpp11::decay_t<const doubles_matrix<>&>>(x)));
  END_CPP11
}
// 06_typedefs.cpp
list typedef_spmat_int_exchangeability(const integers_matrix<>& x);
extern "C" SEXP _cpp11armadillotest_typedef_spmat_int_exchangeability(SEXP x) {
  BEGIN_CPP11
