...
author:
  - name: Mauricio Vargas Sepúlveda
    affiliations:
      - ref: dept-political-science
      - ref: munk-school
    notes: |
      "1 Devonshire Pl, Toronto, ON M5S 3K7, Canada"
    corresponding: true
  - name: Jonathan Schneider Malamud
    affiliations:
      - ref: dept-electrical-engineering
affiliations:
  - id: dept-political-science
  ...
  - id: dept-electrical-engineering
    name: Department of Electrical and Computer Engineering, University of Toronto
format:
  pdf: default
  plos-pdf:
    id: plosone
