...
inline typename enable_if2<is_real<typename T1::elem_type>::value, void>::result interp2(
  ...
  arma_debug_check((UXG.M.n_elem < 2),
                   "interp2(): X must have at least two unique elements");
  arma_debug_check((UYG.M.n_elem < 2),
  ...
  arma_debug_check((UXG.M.is_sorted("strictascend") == false),
                   "interp2(): X must be monotonically increasing");
  arma_debug_check((UYG.M.is_sorted("strictascend") == false),
                   "interp2(): Y must be monotonically increasing");

  arma_debug_check((UXI.M.is_sorted("strictascend") == false),
                   "interp2(): XI must be monotonically increasing");
  arma_debug_check((UYI.M.is_sorted("strictascend") == false),
