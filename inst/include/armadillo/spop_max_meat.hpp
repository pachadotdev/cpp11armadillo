...
template <typename T1>
inline void spop_max::apply_proxy(
...
template <typename T1>
inline typename T1::elem_type spop_max::vector_max(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result spop_max::max_with_index(
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result spop_max::max_with_index(
    const SpProxy<T1>& P, uword& index_of_max_val) {
  arma_extra_debug_sigprint();
