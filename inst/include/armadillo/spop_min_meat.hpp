...
inline void spop_min::apply(SpMat<typename T1::elem_type>& out,
                            const SpOp<T1, spop_min>& in) {
...
template <typename T1>
inline void spop_min::apply_proxy(
    SpMat<typename T1::elem_type>& out, const SpProxy<T1>& p, const uword dim,
...
template <typename T1>
inline typename T1::elem_type spop_min::vector_min(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result spop_min::min(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result spop_min::min_with_index(
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result spop_min::min(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_extra_debug_sigprint();
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result spop_min::min_with_index(
    const SpProxy<T1>& P, uword& index_of_min_val) {
  arma_extra_debug_sigprint();
