...
inline void SpCol<eT>::shed_row(const uword row_num) {
  ...
  arma_debug_check_bounds(row_num >= SpMat<eT>::n_rows,
...
//   arma_extra_debug_sigprint();
//
//   arma_debug_check(set_to_zero == false, "SpCol::insert_rows(): cannot set nonzero
//   values");
//
//   arma_debug_check_bounds((row_num > SpMat<eT>::n_rows), "SpCol::insert_rows(): out of
//   bounds");
//
