...
template <typename T1>
inline void op_sp_minus_pre::apply(SpMat<typename T1::elem_type>& out,
                                   const SpToDOp<T1, op_sp_minus_pre>& in) {
  arma_extra_debug_sigprint();
...
inline void op_sp_minus_pre::apply_inside_schur(SpMat<eT>& out, const T2& x,
  ...
  arma_debug_assert_same_size(proxy2.get_n_rows(), proxy2.get_n_cols(),
                              proxy3.get_n_rows(), proxy3.get_n_cols(),
...
template <typename T1>
inline void op_sp_minus_post::apply(SpMat<typename T1::elem_type>& out,
                                    const SpToDOp<T1, op_sp_minus_post>& in) {
  arma_extra_debug_sigprint();
