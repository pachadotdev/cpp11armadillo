...
# Two-dimensional Fast Fourier Transform {#fft-ifft}
...
polyfit( P, X, Y, N )
    ...
    The given function is modelled as:
        y = p0xN + p1xN-1 + p2xN-2 + ... + pN-1x1 + pN where pi is the i-th polynomial coefficient; the coefficients are selected to minimise the overall error of the fit (least squares)
...
<!-- Y = polyval( P, X )
    ...
    For each x value in vector X, the corresponding y value in vector Y is generated using:
        y = p0xN + p1xN-1 + p2xN-2 + ... + pN-1x1 + pN where pi is the i-th polynomial coefficient in vector P
