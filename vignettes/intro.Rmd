...
intermediate C++ matrices are denoted by `X`, `Y`, `Z`.
...
In this case, the function returns a list of matrices after using two different
Armadillo implementations of the QR decomposition.
