...
[![CRAN status](https://www.r-pkg.org/badges/version/armadillo)](https://CRAN.R-project.org/package=armadillo)
<!-- badges: end -->

The goal of armadillo is to provide a novel approach to use the [Armadillo
...
be used to continue improving `armadillo`.
